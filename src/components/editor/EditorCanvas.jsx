...
export default function EditorCanvas({
  ...
  return (
    <div className="flex-1 flex flex-col min-h-0 overflow-hidden bg-slate-50 dark:bg-[#0f172a]">
      {/* Stage — scrollable */}
      <div ref={canvasContainerRef} className="flex-1 min-h-0 overflow-auto pr-8">
      ...
      {/* Height profile — fixed at bottom, expands upward */}
