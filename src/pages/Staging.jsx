...
import { computeGuide } from '../lib/stagingGuide'
import RehearsalFocusPicker from '../components/staging/RehearsalFocusPicker'
import RehearsalGuideSheet from '../components/staging/RehearsalGuideSheet'
import RehearsalNavMenu from '../components/staging/RehearsalNavMenu'
    ...
    <div className="bg-page flex flex-col overflow-hidden select-none" style={{ height: '100dvh' }}>
      ...
      {guideOpen && highlightedMember && (
        <RehearsalGuideSheet
          ...
          rowElevations={rowElevations} rowLabels={rowLabels} />
      )}
      {menuOpen && (
        <RehearsalNavMenu
