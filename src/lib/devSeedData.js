...
export const SEED_MEMBERS = [
  ...
  { id: 'dev-m-bar-1', first_name: 'Juli',    last_name: 'Algar',    name: 'Juli Algar',    initials: 'JA', voice: 'baritone', role: 'choir', height: 178, birth_date: '1988-06-17', joined_at: null, instagram: 'julialgar_music', google_account: '' },
  { id: 'dev-m-bar-2', first_name: 'Pau',     last_name: 'Voces',    name: 'Pau Voces',     initials: 'PV', voice: 'baritone', role: 'choir', height: 175, birth_date: '1991-03-22', joined_at: null, instagram: '', google_account: '' },
  { id: 'dev-m-bar-3', first_name: 'Pau',     last_name: 'Robles',   name: 'Pau Robles',    initials: 'PR', voice: 'baritone', role: 'choir', height: 176, birth_date: '1985-11-08', joined_at: null, instagram: '', google_account: '' },
  { id: 'dev-m-bar-4', first_name: 'Andreu',  last_name: 'Torres',   name: 'Andreu Torres', initials: 'AT', voice: 'baritone', role: 'choir', height: 180, birth_date: '1993-06-24', joined_at: null, instagram: 'andreutorres', google_account: '' },
  { id: 'dev-m-bar-5', first_name: 'Ale',     last_name: 'Acosta',   name: 'Ale Acosta',    initials: 'AA', voice: 'baritone', role: 'choir', height: 177, birth_date: '1990-09-14', joined_at: null, instagram: '', google_account: '' },

  // ── BAIXOS (salmó) ──
  { id: 'dev-m-bas-1', first_name: 'Ricard',  last_name: 'Mas',      name: 'Ricard Mas',    initials: 'RM', voice: 'bass', role: 'choir', height: 182, birth_date: '1987-04-05', joined_at: null, instagram: '', google_account: '' },
  { id: 'dev-m-bas-2', first_name: 'Ramón',   last_name: 'Diez',     name: 'Ramón Diez',    initials: 'RD', voice: 'bass', role: 'choir', height: 179, birth_date: '1982-12-30', joined_at: null, instagram: '', google_account: '' },
  { id: 'dev-m-bas-3', first_name: 'Marc',    last_name: 'Vives',    name: 'Marc Vives',    initials: 'MV', voice: 'bass', role: 'choir', height: 181, birth_date: '1995-06-19', joined_at: null, instagram: 'marcvives.music', google_account: '' },
  { id: 'dev-m-bas-4', first_name: 'Pol',     last_name: 'Aviñó',    name: 'Pol Aviñó',     initials: 'PA', voice: 'bass', role: 'choir', height: 183, birth_date: '1998-02-11', joined_at: null, instagram: '', google_account: '' },
  ...
  { id: 'dev-m-t1-sp', first_name: 'Sergi',   last_name: 'Pedrosa',  name: 'Sergi Pedrosa', initials: 'SP', voice: 'tenor1', role: 'choir', height: 177, birth_date: '1991-01-15', joined_at: null, instagram: '', google_account: '' },
  { id: 'dev-m-t1-aa', first_name: 'Arnau',   last_name: 'Arguimbau',name: 'Arnau Arguimbau',initials: 'AA', voice: 'tenor1', role: 'choir', height: 176, birth_date: '1997-06-20', joined_at: null, instagram: 'arguimbau_arnau', google_account: '' },
  { id: 'dev-m-t1-jm', first_name: 'Joan Manel',last_name:'Estrany', name: 'Joan Manel Estrany',initials:'JM',voice: 'tenor1', role: 'choir', height: 179, birth_date: '1983-03-08', joined_at: null, instagram: '', google_account: '' },

  // ── SOPRANOS 1 (blau fosc) ──
  { id: 'dev-m-s1-mf', first_name: 'Marta',   last_name: 'Fernández',name: 'Marta Fernández',initials:'MF', voice: 'soprano1', role: 'choir', height: 163, birth_date: '1990-06-16', joined_at: null, instagram: 'marta.fdez', google_account: '' },
  { id: 'dev-m-s1-sk', first_name: 'Stella',  last_name: 'Kohen',    name: 'Stella Kohen',  initials: 'SK', voice: 'soprano1', role: 'choir', height: 161, birth_date: '1988-09-25', joined_at: null, instagram: '', google_account: '' },
  { id: 'dev-m-s1-cd', first_name: 'Cris',    last_name: 'Díaz',     name: 'Cris Díaz',     initials: 'CD', voice: 'soprano1', role: 'choir', height: 165, birth_date: '1995-12-04', joined_at: null, instagram: '', google_account: '' },

  // ── SOPRANOS 2 (blau clar) ──
  { id: 'dev-m-s2-js', first_name: 'Judith',  last_name: 'Sabaté',   name: 'Judith Sabaté', initials: 'JS', voice: 'soprano2', role: 'choir', height: 160, birth_date: '1993-07-11', joined_at: null, instagram: '', google_account: '' },
  { id: 'dev-m-s2-ic', first_name: 'Irene',   last_name: 'Cabedo',   name: 'Irene Cabedo',  initials: 'IC', voice: 'soprano2', role: 'choir', height: 162, birth_date: '1986-06-22', joined_at: null, instagram: 'irenecabedo_', google_account: '' },
  { id: 'dev-m-s2-lm', first_name: 'Laura',   last_name: 'Martínez', name: 'Laura Martínez',initials: 'LM', voice: 'soprano2', role: 'choir', height: 164, birth_date: '1991-04-18', joined_at: null, instagram: '', google_account: '' },
  { id: 'dev-m-s2-gl', first_name: 'Gisela',  last_name: 'Lacasta',  name: 'Gisela Lacasta',initials: 'GL', voice: 'soprano2', role: 'choir', height: 158, birth_date: '1989-02-27', joined_at: null, instagram: '', google_account: '' },
  { id: 'dev-m-s2-ms', first_name: 'María',   last_name: 'Saez',     name: 'María Saez',    initials: 'MS', voice: 'soprano2', role: 'choir', height: 166, birth_date: '1994-11-03', joined_at: null, instagram: '', google_account: '' },

  // ── ALTS 1 (fúcsia/lila) ──
  { id: 'dev-m-a1-ap', first_name: 'Adriana', last_name: 'Palomo',   name: 'Adriana Palomo',initials: 'AP', voice: 'alto1', role: 'choir', height: 161, birth_date: '1992-06-26', joined_at: null, instagram: 'adrianapalomo.art', google_account: '' },
  { id: 'dev-m-a1-ai', first_name: 'Aina',    last_name: 'Pedrola',  name: 'Aina Pedrola',  initials: 'AiP',voice: 'alto1', role: 'choir', height: 160, birth_date: '1996-08-09', joined_at: null, instagram: '', google_account: '' },
  { id: 'dev-m-a1-mt', first_name: 'Magalí',  last_name: 'Túnica',   name: 'Magalí Túnica', initials: 'MT', voice: 'alto1', role: 'choir', height: 163, birth_date: '1987-05-14', joined_at: null, instagram: '', google_account: '' },
  { id: 'dev-m-a1-ng', first_name: 'Núria',   last_name: 'Galiano',  name: 'Núria Galiano', initials: 'NG', voice: 'alto1', role: 'choir', height: 162, birth_date: '1990-10-30', joined_at: null, instagram: '', google_account: '' },
  { id: 'dev-m-a1-sc', first_name: 'Silvia',  last_name: 'Colell',   name: 'Silvia Colell', initials: 'SC', voice: 'alto1', role: 'choir', height: 159, birth_date: '1985-07-07', joined_at: null, instagram: '', google_account: '' },
  { id: 'dev-m-a1-sr', first_name: 'Sonia',   last_name: 'Ruiz',     name: 'Sonia Ruiz',    initials: 'SR', voice: 'alto1', role: 'choir', height: 164, birth_date: '1993-01-19', joined_at: null, instagram: '', google_account: '' },
  { id: 'dev-m-a1-mk', first_name: 'Mariona', last_name: 'Kazumi',   name: 'Mariona Kazumi',initials: 'MK', voice: 'alto1', role: 'choir', height: 161, birth_date: '1998-03-31', joined_at: null, instagram: '', google_account: '' },

  // ── ALTS 2 (rosa/lavanda) ──
  { id: 'dev-m-a2-ac', first_name: 'Alicia',  last_name: 'Cubero',   name: 'Alicia Cubero', initials: 'AC', voice: 'alto2', role: 'choir', height: 160, birth_date: '1991-06-18', joined_at: null, instagram: 'aliciacubero_veu', google_account: '' },
  { id: 'dev-m-a2-ar', first_name: 'Anna',    last_name: 'Restoy',   name: 'Anna Restoy',   initials: 'AR', voice: 'alto2', role: 'choir', height: 163, birth_date: '1988-09-02', joined_at: null, instagram: '', google_account: '' },
  { id: 'dev-m-a2-am', first_name: 'Anna',    last_name: 'Martin',   name: 'Anna Martin',   initials: 'AM', voice: 'alto2', role: 'choir', height: 162, birth_date: '1994-12-15', joined_at: null, instagram: '', google_account: '' },
  { id: 'dev-m-a2-mfm',first_name: 'Maria',   last_name: 'Fernandez',name: 'Maria Fernandez',initials:'MF', voice: 'alto2', role: 'choir', height: 161, birth_date: '1986-04-23', joined_at: null, instagram: '', google_account: '' },
  { id: 'dev-m-a2-cg', first_name: 'Cristina',last_name: 'Grau',     name: 'Cristina Grau', initials: 'CG', voice: 'alto2', role: 'choir', height: 158, birth_date: '1992-07-01', joined_at: null, instagram: '', google_account: '' },
  { id: 'dev-m-a2-mg', first_name: 'Maria',   last_name: 'Granell',  name: 'Maria Granell', initials: 'MG', voice: 'alto2', role: 'choir', height: 160, birth_date: '1989-06-15', joined_at: null, instagram: 'mariagranell', google_account: '' },
]
